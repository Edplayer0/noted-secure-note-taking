...
class Editor(tk.Frame):
    def __init__(self, master):
        ...
        self.editor_entry = tk.Entry(self, font=("Segoe Script", 20),
        ...
        self.editor_text = tk.Text(self.editor_text_frame, pady=20, padx=20,
        ...
        self.scroll = tk.Scrollbar(self.editor_text_frame,
    ...
    def save(self):
        ...
        try:
            ...
            if (current_title and current_title != "Título de la nota..." and
                    current_content):
